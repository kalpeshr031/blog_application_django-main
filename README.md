To install this project, you'll need to have Python 3 and Django installed on your machine. Then, you can clone the repository and install the required packages using pip:
